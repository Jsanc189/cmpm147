...
function setup() {
  ...
  createP("Change the World key for different building arrangements.").parent("container");
  createP("Arrow keys scroll. Clicking a tile spawns a building.").parent("container");
