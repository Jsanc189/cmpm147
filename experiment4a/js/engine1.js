...
function setup() {
  ...
  let canvas = createCanvas(canvasContainer.width(), canvasContainer.height() - 200);
  ...
  createP("Enter a new world key to change the water").parent("canvas-container1");
  createP("Arrow keys scroll. Clicking places sea creatures or plants.").parent("canvas-container1");
